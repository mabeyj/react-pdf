...
var resolveMediaQueries = function resolveMediaQueries(input, container) {
  var result = Object.keys(input).reduce(function (acc, key) {
    ...
    if (/@media/.test(key)) {
      ...
      return _extends(_extends({}, acc), matchMedia((_matchMedia = {}, _matchMedia[key] = input[key], _matchMedia), container));
    }

    return _extends(_extends({}, acc), {}, (_extends2 = {}, _extends2[key] = input[key], _extends2));
  }, {});
  return result;
};
...
var Base = /*#__PURE__*/function (_Node) {
  ...
  _proto.resolveStyles = function resolveStyles() {
    ...
    return _extends(_extends({}, inheritedStyles), ownStyles);
  };
        ...
        if (font !== lastFont) {
          if (lastFont) {
            res.push({
              ...
              attributes: {
                font: lastFont //scale: lastFont ? fontSize / lastFont.unitsPerEm : 0,
    ...
    while (match = regex.exec(fragment.string)) {
      ...
      if (emojis[emoji] && emojis[emoji].data) {
        result.push({
          ...
          attributes: _extends(_extends({}, fragment.attributes), {}, {
            attachment: {
              width: emojiSize,
              height: emojiSize,
  ...
  instance.children.forEach(function (child) {
    if (isImage(child)) {
      fragments.push({
        ...
        attributes: _extends(_extends({}, attributes), {}, {
          attachment: {
...
function _createForOfIteratorHelperLoose$2(o) { var i = 0; if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (o = _unsupportedIterableToArray$2(o))) return function () { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }; throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } i = o[Symbol.iterator](); return i.next.bind(i); }
...
var painter = function painter(instance) {
  var p = availableMethods.reduce(function (acc, prop) {
    ...
    return _extends(_extends({}, acc), {}, (_extends2 = {}, _extends2[prop] = function () {
...
var pdf = function pdf(input) {
  ...
  function callOnRender(params) {
    ...
    if (container.document.props.onRender) {
      ...
      container.document.props.onRender(_extends(_extends({}, params), {}, {
...
var flatStyles = function flatStyles(stylesArray) {
  return stylesArray.reduce(function (acc, style) {
    return _extends(_extends({}, acc), style);
  }, {});
};
